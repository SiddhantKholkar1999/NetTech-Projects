...
function Car(make, model, year) {
    (this.make = make), (this.make = model), (this.make = year);
}
...
// We write the object this way normally
...
// todosAns-> constructor to build something new or to create something from scratch. This constructor method in js is a special function used to create objects.
...
var myPlayer1 = new Player('Kohli', 'RoyalChallengerBangalore');
...
myFunctions.call(Person5, [24, 'pune']);  //here we will give to arg as a '[]' to separate and send the value
console.log(Person5);
...
// bind - so in bind we execute the code this manner.
...
let myBind = myFunctions3.bind(Person7, 24, 'pune'); // here we have to catch the value coming from bind so we took to a variable.
